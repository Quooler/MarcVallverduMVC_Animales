...
namespace MVC_MarcVallverdu.ViewComponents
{
    public class InteractivoTipoAnimalesViewComponent : ViewComponent
    {
        ...
        public IViewComponentResult Invoke()
        {
            Dictionary<string, string> tiposAnimal = new Dictionary<string, string>()
            {
                ...
                {
                    "Jirafas", "Las jirafas son animales con cuellos largos y patrones únicos en pelaje," +
                ...
                {
                    "Tigres", "Los tigres son felinos grandes y poderosos que tienen rayas en su pelaj y son animales " +
